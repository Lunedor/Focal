  ...
  enter(wrapper, key, content, options = {}) {
    ...
    toolbar.addEventListener('click', (evt) => {
      ...
      if (action === 'books') {
        ...
        doneButton.style.cssText = 'text-align:center;padding:8px;margin-top:8px;font-weight:500;background:var(--color-button,#007acc);color:white;cursor:pointer;border-radius:0 0 4px 4px;';
        dropdown.appendChild(doneButton);
