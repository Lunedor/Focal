...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('.sync-cloud-btn').addEventListener('click', () => {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (notificationsBtn) {
        function updateNotificationsBtn() {
            if ('Notification' in window) {
                const permission = Notification.permission;
                if (permission === 'granted') {
                    notificationsBtn.querySelector('span').textContent = 'Notifications: On';
                    notificationsBtn.classList.add('active');
                } else if (permission === 'denied') {
                    notificationsBtn.querySelector('span').textContent = 'Notifications: Blocked';
                    notificationsBtn.disabled = true;
                } else {
                    notificationsBtn.querySelector('span').textContent = 'Enable Notifications';
